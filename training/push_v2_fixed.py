"""Re-push fixed training kernels with correct dataset paths."""
...
# Kaggle mounts datasets at /kaggle/input/datasets/{username}/{dataset-slug}/
MOUNT_PATHS = {
    "leaf": {
...
# Distribution: 2 per account
KERNELS = [
    {"dataset": "leaf", "model": "custom_cnn", "username": "julianmedinamonje45",
     "slug": "coffeevision-leaf-cnn-v2", "title": "CoffeeVision Leaf CNN V2",
    ...
    {"dataset": "leaf", "model": "resnet50", "username": "julianmedinamonje45",
     "slug": "coffeevision-leaf-resnet50-v2", "title": "CoffeeVision Leaf ResNet50 V2",
     "num_classes": 14, "class_names": LEAF_CLASSES,
     "dataset_slug": "julianmedinamonje45/coffevision-leaf-cls"},
    {"dataset": "grain", "model": "custom_cnn", "username": "vann234",
     "slug": "coffeevision-grain-cnn-v2", "title": "CoffeeVision Grain CNN V2",
    ...
    {"dataset": "grain", "model": "resnet50", "username": "vann234",
     "slug": "coffeevision-grain-resnet50-v2", "title": "CoffeeVision Grain ResNet50 V2",
     "num_classes": 3, "class_names": GRAIN_CLASSES,
     "dataset_slug": "vann234/coffevision-grain-cls"},
    {"dataset": "leaf", "model": "efficientnetb0", "username": "juanveru",
     "slug": "coffeevision-leaf-efficientnet-v2", "title": "CoffeeVision Leaf EfficientNet V2",
     "num_classes": 14, "class_names": LEAF_CLASSES,
     "dataset_slug": "juanveru/coffevision-leaf-cls"},
    {"dataset": "grain", "model": "efficientnetb0", "username": "juanveru",
     "slug": "coffeevision-grain-efficientnet-v2", "title": "CoffeeVision Grain EfficientNet V2",
     "num_classes": 3, "class_names": GRAIN_CLASSES,
...
"""
    ...
    for src, ctype in [(cell1, "code"), (cell2, "code"), (cell3, "code"),
        ...
        cells.append({
            ...
            "id": os.urandom(8).hex(),  # Fix MissingIDFieldWarning
        })
...
if __name__ == "__main__":
    print("=" * 70)
    print("CoffeeVision AI — V2 Kernels (Fixed Dataset Paths)")
    print("=" * 70)
    for kcfg in KERNELS:
    ...
    print("\n" + "=" * 70)
    print("All V2 kernels pushed! Monitoring URLs:")
    for kcfg in KERNELS:
